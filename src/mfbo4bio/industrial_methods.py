...
def run(
    ...
    None
        ...
        to a JSON file in the `./results/industrial` directory.
    ...
    try:
        ...
        os.makedirs(
            f"../results/industrial/{clone_distribution}_{cond}/{sampling_method}",
            exist_ok=True,
        )
        with open(
            f"../results/industrial/{clone_distribution}_{cond}/{sampling_method}/{output_name}.json",
            "w",
        ) as f:
